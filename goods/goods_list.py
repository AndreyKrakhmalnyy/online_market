"""Переменная, содержащая информацию о товарах.

    Атрибуты:
        image: str - относительный путь до изображения;
...
goods = [
    ...
    },
    {
        ...
        "name": "Прикроватный столик (металл-дерево)",
    ...
    },
    {
        ...
        "name": "Прикроватный столик (деревянный)",
        "description": "Деревянный столик, довольно странный на вид, но подходит для размещения рядом с кроватью.",
        "price": 25.00,
    },
]
